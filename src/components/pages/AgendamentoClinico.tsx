...
import {
  ...
  type AgendamentoClinicoFormData,
} from '../schemas/AgendamentoClinicoSchema';
import { StethoscopeIcon, User, Clock, CalendarDays } from 'lucide-react';
...
export function AgendamentoClinico() {
  ...
  function handleFormSubmit(data: AgendamentoClinicoFormData) {
    console.log('Agendamento Clínico validado e pronto', data);
  ...
  return (
    <div className='p-8 flex justify-center items-start min-h-[calc(100vh-150px)]'>
      <div className='bg-white p-8 rounded-lg shadow-xl w-full max-w-2xl'>
        <h1 className='text-3xl font-bold text-center text-cyan-600 mb-6 border-b-2 border-yellow-400 pb-2'>
          Agendamento Clínico
        </h1>
        ...
        >
          ...
          <button
            type='submit'
            className='mt-4 p-3 bg-cyan-600 text-white font-semibold rounded hover:bg-cyan-700 transition'
          >
            Agendar Consulta
          </button>
        </form>
